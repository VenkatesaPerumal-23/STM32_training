...
int main(void)
{
    ...
    // Button config -> interrupt2

    gpioButton1.pGPIOx = GPIOC;
    gpioButton1.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NO_6;
    gpioButton1.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_IT_RFT;
...
{
    delay();
    GPIO_IRQHandling(GPIO_PIN_NO_6);             // clear pending bit
